...
set -x+ ./linear-circuit.py 1 2 I 5, 2 3 R 2, 3 1 R 3
NODE VOLTAGES: [-15.0, 10.0, 0.0]
+ ./linear-circuit.py 1 2 U 5, 2 3 R 2, 3 1 R 3
NODE VOLTAGES: [3.0, -2.0, 0.0]
+ ./linear-circuit.py 1 2 U 1, 2 3 R 2, 3 4 I 2, 4 1 R 1, 2 3 R 3
NODE VOLTAGES: [-2.0, -3.0, -5.4, 0.0]
+ ./linear-circuit.py 1 2 U 1, 2 3 R 2, 3 4 I 2, 4 5 I 2, 5 1 R 1
Linear system is singular or ill-conditioned; solution not found.
